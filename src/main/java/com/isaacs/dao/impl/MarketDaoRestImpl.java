...
public class MarketDaoRestImpl implements Serializable, MarketDao {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7220175613471159283L;
	static Logger logger = Logger.getLogger(MarketDaoRestImpl.class);
	static final String url = "/MarketService";
